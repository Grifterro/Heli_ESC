...
#define BEMF_ON_SENSING_DIVIDER              9.208955 /*!< BEMF voltage divider during PWM ON time
                                                   for zero crossing detection */
/*********** Bus voltage sensing section ****************/
#define VBUS_PARTITIONING_FACTOR             0.09624639076034648 /*!< It expresses how
                                                      much the Vbus is attenuated
                                                      before being converted into
                                                      digital value */
#define NOMINAL_BUS_VOLTAGE_V                22U
